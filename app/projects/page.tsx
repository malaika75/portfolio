...
<div className="h-12/12 w-96 relative group sm:ml-20 lg:mx-4 xl:ml-20 overflow-hidden flex justify-center">
      <Image src="https://researchtweet.com/wp-content/uploads/2024/01/Free-Resume-Builders.jpg" alt="game-pic" className="border-2 border-gray-800 cursor-pointer object-cover max-w-[350px] sm:max-w-[380px] mr-4" width={500} height={500} />
