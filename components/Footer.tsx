...
<div className='flex justify-center w-full'>
    <div>
      <img src="https://img.freepik.com/free-vector/network-mesh-wire-digital-technology-background_1017-27428.jpg?w=360" alt="footer-bg"  className='h-96'/>
        </div>
...
// https://media.istockphoto.com/id/1311939407/vector/thank-you-ink-brush-vector-lettering.jpg?s=612x612&w=0&k=20&c=vXYFAtBGR0MgPaIHAHOPcECRJI0bSv4Bg_nLiF5XxQ0=
// https://media.istockphoto.com/id/1383447162/vector/90s-retro-vaporwave-aesthetics-digital-screen-user-interface-cute-old-computer-ui-elements.jpg?s=612x612&w=0&k=20&c=NRDpByU-7UXfW-RgxyPDjukoPiPb-P7-5-_MnBc7pyo=